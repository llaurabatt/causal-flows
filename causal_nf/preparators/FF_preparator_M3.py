from causal_nf.datasets.FF_dataset_M3 import FFDatasetM3
...
class FFPreparatorM3(TabularPreparator):
    def __init__(self, add_noise, dataset_filename, **kwargs):

        self.dataset = None
        self.dataset_filename = dataset_filename
        self.add_noise = add_noise
        sem_fn = sem_dict["FF_data_M3"](sem_name="dummy")
    ...
    def loader(cls, dataset):
        my_dict = FFPreparatorM3.params(dataset)
