from causal_nf.datasets.FF_dataset_M1 import FFDatasetM1
...
class FFPreparatorM1(TabularPreparator):
    def __init__(self, add_noise, dataset_filename, **kwargs):

        self.dataset = None
        self.dataset_filename = dataset_filename
        self.add_noise = add_noise
        sem_fn = sem_dict["FF_data_M1"](sem_name="dummy")
    ...
    def loader(cls, dataset):
        my_dict = FFPreparatorM1.params(dataset)
